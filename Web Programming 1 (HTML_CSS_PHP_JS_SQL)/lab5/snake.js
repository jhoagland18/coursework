...
(function(){
	...
	Snake.prototype.isFoodEaten = function () {
		...
		var foodTop = parseInt(food.compStyle.top);
		var foodLeft = parseInt(food.compStyle.left);
		var headTop = parseInt(head.compStyle.top);
		var headLeft = parseInt(head.compStyle.left);

		if(foodTop == headTop && foodLeft == headLeft)
			return true;
		return 	false;
	};
